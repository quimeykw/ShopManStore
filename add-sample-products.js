...
/**
 * Script para añadir productos de ejemplo a la base de datos
 */

const db = require('./db-config');

console.log('🛍️ Añadiendo productos de ejemplo a ShopManStore...\n');
  ...
  db.run(
    ...
    function(err) {
      ...
      if (completed === total) {
        ...
        console.log('   Inicia el servidor y verifica que aparezcan en la página principal.');
...
console.log(`🔄 Procesando ${total} productos...`);